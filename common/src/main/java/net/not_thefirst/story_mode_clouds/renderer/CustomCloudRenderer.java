...
public class CustomCloudRenderer implements AutoCloseable {
    ...
    private void tryBuildClouds(LayerState currentLayer, float relY, int layer, int skyColor) {
        ...
        IndexedCompiledMesh mesh = buildMeshForLayer(
        ...
        if (mesh != null) {
            currentLayer.buffer = MeshUploader.uploadIndexed(mesh);
    ...
    @Nullable
    private IndexedCompiledMesh buildMeshForLayer(Texture.TextureData tex,
