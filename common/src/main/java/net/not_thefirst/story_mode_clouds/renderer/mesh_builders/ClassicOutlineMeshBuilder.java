...
public class ClassicOutlineMeshBuilder implements MeshTypeBuilder {
        ...
        for (int dz = -range; dz <= range; dz++) {
            for (int dx = -range; dx <= range; dx++) {
                ...
                if (cell != 0L) {
                    ...
                    buildExtrudedCell(bb, dx, dz, cell, relY, currentLayer, 
     ...
     * @param bb Mesh.
     * @param x0 v0's x coordinate
     * @param y0 v0's y coordinate
     * @param z0 v0's z coordinate
     * @param x1 v1's x coordinate
     * @param y1 v1's y coordinate
     * @param z1 v1's z coordinate
     * @param x2 v2's x coordinate
     * @param y2 v2's y coordinate
     * @param z2 v2's z coordinate
     * @param x3 v3's x coordinate
     * @param y3 v3's y coordinate
     * @param z3 v3's z coordinate
     * @param colorModifier Color.
     */
