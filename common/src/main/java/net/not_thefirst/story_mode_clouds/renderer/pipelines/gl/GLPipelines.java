package net.not_thefirst.story_mode_clouds.renderer.pipelines.gl;
...
public class GLPipelines {
    ...
    public static void init() {
        ...
        manager.registerPipeline(CUSTOM_POSITION_COLOR);
        manager.registerPipeline(POSITION_COLOR_NO_DEPTH);
        manager.registerPipeline(POSITION_COLOR_DEPTH_ONLY);
        manager.registerPipeline(NONE);
    }
}
