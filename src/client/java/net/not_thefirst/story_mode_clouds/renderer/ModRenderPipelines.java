...
public class ModRenderPipelines {
    ...
    public static void registerCloudPipelines() {
        ResourceLocation loc1 = ResourceLocation.fromNamespaceAndPath(StoryModeClouds.MOD_ID, "pipeline/pos_tex_c");
        ResourceLocation lc1 = ResourceLocation.fromNamespaceAndPath(StoryModeClouds.MOD_ID, "rt_clouds");
        ...
        POSITION_COLOR_DEPTH = builder.withColorWrite(true, false).withDepthWrite(true).build();
    }
