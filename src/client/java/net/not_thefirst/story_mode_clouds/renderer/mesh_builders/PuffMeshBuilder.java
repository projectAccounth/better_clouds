...
public class PuffMeshBuilder implements MeshTypeBuilder {
    ...
    public BufferBuilder Build(
        BufferBuilder bb, TextureData tex, 
    ...
    private static void drawCube(
        ...
        // Top face
        bb.vertex(x0, y1, z1).color(topR, topG, topB, topA).endVertex();
        bb.vertex(x1, y1, z1).color(topR, topG, topB, topA).endVertex();
        bb.vertex(x1, y1, z0).color(topR, topG, topB, topA).endVertex();
        bb.vertex(x0, y1, z0).color(topR, topG, topB, topA).endVertex();

        // Bottom face
        bb.vertex(x0, y0, z0).color(bottomR, bottomG, bottomB, bottomA).endVertex();
        bb.vertex(x1, y0, z0).color(bottomR, bottomG, bottomB, bottomA).endVertex();
        bb.vertex(x1, y0, z1).color(bottomR, bottomG, bottomB, bottomA).endVertex();
        bb.vertex(x0, y0, z1).color(bottomR, bottomG, bottomB, bottomA).endVertex();

        bb.vertex(x0, y0, z1).color(sideBottomR, sideBottomG, sideBottomB, sideBottomA).endVertex();
        bb.vertex(x1, y0, z1).color(sideBottomR, sideBottomG, sideBottomB, sideBottomA).endVertex();
        bb.vertex(x1, y1, z1).color(sideTopR, sideTopG, sideTopB, sideTopA).endVertex();
        bb.vertex(x0, y1, z1).color(sideTopR, sideTopG, sideTopB, sideTopA).endVertex();

        bb.vertex(x1, y0, z0).color(sideBottomR, sideBottomG, sideBottomB, sideBottomA).endVertex();
        bb.vertex(x0, y0, z0).color(sideBottomR, sideBottomG, sideBottomB, sideBottomA).endVertex();
        bb.vertex(x0, y1, z0).color(sideTopR, sideTopG, sideTopB, sideTopA).endVertex();
        bb.vertex(x1, y1, z0).color(sideTopR, sideTopG, sideTopB, sideTopA).endVertex();
    ...
    private static void drawCross(
        ...
        bb.vertex(cx - hr, y0, cz).color(bottomR, bottomG, bottomB, bottomA).endVertex();
        bb.vertex(cx + hr, y0, cz).color(bottomR, bottomG, bottomB, bottomA).endVertex();
        bb.vertex(cx + hr, y1, cz).color(topR, topG, topB, topA).endVertex();
        bb.vertex(cx - hr, y1, cz).color(topR, topG, topB, topA).endVertex();

        bb.vertex(cx, y0, cz - hr).color(bottomR, bottomG, bottomB, bottomA).endVertex();
        bb.vertex(cx, y0, cz + hr).color(bottomR, bottomG, bottomB, bottomA).endVertex();
        bb.vertex(cx, y1, cz + hr).color(topR, topG, topB, topA).endVertex();
        bb.vertex(cx, y1, cz - hr).color(topR, topG, topB, topA).endVertex();
    }
}